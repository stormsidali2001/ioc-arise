...
export class TypeDeclarationGenerator {
    static generate(classes: ClassInfo[], outputPath: string, factories?: FactoryInfo[]): void {
        ...
        const typeDeclarations = this.generateTypeDeclarations(classes, outputPath, factories);
        mkdirSync(dirname(outputPath), { recursive: true });
        writeFileSync(outputPath, typeDeclarations);
    }

    private static generateTypeDeclarations(classes: ClassInfo[], outputPath: string, factories?: FactoryInfo[]): string {
...
`;
        ...
        const typeImports = this.generateTypeImports(interfaceClasses, abstractClasses, directClasses, outputPath, factories);
